  ...
  return (
    <>
      ...
      <TableComponent
        ...
        description="Create and manage External Users here"
        createBtn={true}
        onCreateClick={handleCreateUser}
        actionIcons={true}
        apiEndpoint="/auth/external-users/"
        extraParams={{
        ...
        pageId={PAGE_IDS.EXTERNAL_USER_LIST}
